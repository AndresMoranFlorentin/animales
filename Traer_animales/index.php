...
<h1>Listado de animales</h1>
    ...
    <form action="agregar_info.php" method="post" class="my-form">
...
foreach ($todo_lo_que_hay as $recorrer) {
    ...
    $descrip = $recorrer["descripcion"];
    $alimentacion = $recorrer["alimentacion"];
    $habitat = $recorrer["habitat"];
    $id = $recorrer['id_animales'];

    echo ("<td>.$nombre.</td>");
    echo ("<td>.$descrip.</td>");
    echo ("<td>.$alimentacion.</td>");
    echo ("<td>.$habitat.</td>");
